    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ padding: '2rem 2.5rem' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: '.6rem', fontWeight: 800, letterSpacing: '.12em', textTransform: 'uppercase', color: '#4A7FDB', marginBottom: '.4rem', fontFamily: 'var(--font-montserrat,sans-serif)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '.5rem', minWidth: 220 }}>
            {[
              ...
              <div key={step.n} style={{ display: 'flex', alignItems: 'center', gap: '.6rem' }}>
                <div style={{ width: 20, height: 20, borderRadius: '50%', background: '#4A7FDB', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '.6rem', fontWeight: 800, fontFamily: 'var(--font-montserrat,sans-serif)', flexShrink: 0 }}>
                  {step.n}
                </div>
          ...
          <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 16, padding: '3rem 2.5rem', textAlign: 'center', boxShadow: '0 2px 8px rgba(15,23,42,.05)' }}>
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.25rem' }}>
              <div style={{ width: 56, height: 56, borderRadius: 14, background: '#fffbeb', border: '2px solid #fde68a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#4A7FDB" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
              </div>
            </div>
            ...
            <a href="https://supabase.com/dashboard/project/lyisdsnocroocxfblvqf/sql/new"
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: '.5rem', background: 'linear-gradient(135deg, #4A7FDB, #2563b8)', color: '#fff', padding: '.65rem 1.75rem', borderRadius: 9999, textDecoration: 'none', fontWeight: 700, fontSize: '.875rem', fontFamily: 'var(--font-montserrat,sans-serif)', boxShadow: '0 4px 14px rgba(74,127,219,.35)' }}>
            ...
            <div style={{ marginTop: '1rem', background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 10, padding: '.75rem 1rem', textAlign: 'left', display: 'inline-block' }}>
              ...
              <code style={{ fontSize: '.78rem', color: '#4A7FDB', fontFamily: 'monospace' }}>supabase/add_transcricoes.sql</code>
            </div>
          </div>
        ) : (
          <TranscricaoForm
