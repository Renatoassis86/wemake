...
export default function FinanceiroPage() {
  return (
    <WipPage
      title="Financeiro"
      subtitle="Controle financeiro da operação comercial e integração com Gestão Financeira"
      tag="Em Breve"
      headline="Visão financeira completa das parcerias e receitas"
      description="Acompanhe o fluxo financeiro das parcerias: valores contratados, recebimentos, inadimplências e projeções. Integrado com os contratos da Jornada Contratual e com a plataforma Gestão Financeira."
      features={[
      ...
      integration={{
        label: "Gestão Financeira — Integração Planejada",
        desc: "Este módulo será integrado com a plataforma Gestão Financeira assim que disponível. Os dados financeiros das parcerias fluirão automaticamente entre os dois sistemas, eliminando retrabalho e garantindo consistência. A URL de integração será configurada em breve.",
      ...
      note="Aguardando os links de integração com a plataforma Gestão Financeira. Assim que disponíveis, a conexão será configurada e o módulo será desenvolvido com dados sincronizados em tempo real."
