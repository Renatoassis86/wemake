...
console.log('Has Parametros e pesos:', body.includes('Parâmetros e pesos'));
console.log('Has Faixa 1:', body.includes('Faixa 1'));
console.log('Has Score Final:', body.includes('Score Final'));
console.log('Has Teto unico:', body.includes('Teto'));
...
console.log('Comodato Maquina digital:', body2.includes('digital'));
